          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (widget.person.isLeukemiaTest)
                ...
                else if (widget.person.isOCRTest)
                  Column(
                    children: [
                      Container(
                        width: double.infinity,
                  ...
                  // Image.network(
                      // "http://192.168.1.37:8000/media/translatedfortranslation/image_picker4093502592341020500.jpg"),
                Image.network(widget.person.transltedImage),
                SizedBox(
                  height: 20.0,
                ),
                Container(
