...
#         # Q1 = suffer from red eyes?
#         self.declare(Fact(red_eyes=Q1A))
#         # Q2 = suffering from fatigue?
#         self.declare(Fact(fatigue=Q2A))
#         # Q3 = shortness of breath?
#         self.declare(Fact(short_breath=Q3A))
#         # Q4 = loss of appetite?
#         self.declare(Fact(appetite_loss=Q4A))
#         # Q5 = suffer from fever?
#         fever = Q5A
#         if fever != "none":
#             fever = fever.replace(" ","_")
#             self.declare(Fact(fever))
#         else:
...
#         self.declare(Fact(joint_pain=yes_no("Do you have any joint pains?")))
...
#         swell_joint=yes_no("Are you experiencing swelling Joints?")
...
#         tired=yes_no("Are you feeling tired even if you walk a small distance?")
#         count=0
...
#         burning_stomach=yes_no("Does your stomach have a burning sensation?")
#         bloating=yes_no("Are you having a feeling of fullness, bloating or belching?")
#         mild_nausea=yes_no("Do you have mild Nausea?")
...
#         self.declare(Fact(muscle_weakness=yes_no("Are your muscles weaker than before?")))
...
#     def askAnemia(self):
#         irregular_heartbeat=yes_no("Are you experiencing an irregular heartbeat?")
#         weakness=yes_no("Are you feeling weak?")
#         pale_skin=yes_no("Has your skin turned pale or yellowish?")
#         lightheadedness=yes_no("Are you having dizziness or lightheadedness?")
...
#     def askCAD(self):
#         heaviness=yes_no("Did you have a feeling of heaviness or tightness, usually in the center of the chest, which may spread to the arms, neck, jaw, back, or stomach?")
#         sweating=yes_no("Are you sweating frequently?")
#         dizziness=yes_no("Are you feeling dizzy?")
#         burning=yes_no("Do you feel a burning sensation near your heart?")
#         count=0
...
#     def askDengue(self):
#         headache=yes_no("Are you experiencing a severe headache?")
#         eyes_pain=yes_no("Are you having pain behind your eyes?")
...
#         rashes=yes_no("Have you experienced rashes on the skin that appear two to five days after the onset of fever?")
#         bleeding=yes_no("Are you having mild bleeding such as a nose bleed, bleeding gums, or easy bruising?")
#         count=0
...
#         headache=yes_no("Are you having a headache?")
...
#         self.declare(Fact(eye_burn=yes_no("Do you have a burning sensation in your eyes?")))
#         self.declare(Fact(eye_crusting=yes_no("Do you get pus or crusting on your eyes?")))
...
# class StartExpertSystem(APIView):
#     def get(self, request):
#         if request.method == "GET":
#             global Q1A, Q2A, Q3A, Q4A, Q5A
#             Q1A = request.GET.get("A1")
#             Q2A = request.GET.get("A2")
#             Q3A = request.GET.get("A3")
#             Q4A = request.GET.get("A4")
#             Q5A = request.GET.get("A5")
...
#         engine.reset()
#         engine.run()
#         print(f'result:: {finalResurl}')
#         return JsonResponse({'finalResurl':finalResurl})
...
#     global finalResurl, engine
#     finalResurl = {'Result':{'disease':disease,'symptoms':symptoms}}
#     print(f'RESULT:: {finalResurl}')
#     engine.halt()
