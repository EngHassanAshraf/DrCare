...
def multi_input(input_str, options=[]): # returns a list of user selected values
    ...
    return [ options[i] for i in choice ] #list contains the choosen fever
...
class MedicalExpert(KnowledgeEngine):
    ...
    def _initial_action_(self):
        # print("Hi. I am Dr Care who can help you with the medical diagnosis")
        # print("When prompted with options, enter space-separated integer values corresponding to all the options which apply to you.")
    ...
    def askBasicQuestions(self):
        ...
        self.declare(Fact(appetite_loss=yes_no("Are you having a loss of appetite?")))
